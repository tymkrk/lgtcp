...
from _tb_employee_compensation_tk
outer apply
...
when matched then update set
	c.TargetValueMin	= r.TargetValueMin	
	,c.TargetValueMax	= r.TargetValueMax	
	,c.TargetValue		= r.TargetValue		
	,c.PaidDate			= IIF(r.PaidValue is not null, DATEFROMPARTS(r.year+1,4,1) , null)
	,c.PaidValue			= r.PaidValue
